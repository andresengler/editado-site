...
export function AboutPage({ onPageChange }: AboutPageProps) {
  ...
  const capabilityDescriptions = {
    ...
    'Aesthetic Direction': 'Translating brand essence into a unique and expressive visual universe.',
    'Tech Integration': 'Deploying custom tech solutions and integrating CMS, CRM, and APIs with efficiency and scalability.',
    'Category Definition': 'Helping brands claim new cultural and strategic space by creating or redefining categories.',
    'Platform Strategy': 'Identifying and shaping the right channels and formats to amplify brand voice and presence.'
  };
  ...
  const CapabilityItem = ({ capability, index, isMobile = false }: { capability: string; index: number; isMobile?: boolean }) => {
    ...
    return (
      <motion.div
        ...
        onTouchStart={() => isMobile && setHoveredCapability(capability)}
        onTouchEnd={() => isMobile && setTimeout(() => setHoveredCapability(null), 1500)}
        initial={false}
        style={{ 
          height: '18px',
          marginBottom: '4px',
      ...
      >
        ...
        <motion.div
          ...
          initial={false}
          animate={{
            x: !isMobile && isHovered ? 10 : (isMobile && isHovered ? 10 : 0),
        ...
        {!isMobile && (
          <motion.div
            className="pointer-events-none hidden md:block ml-4 max-w-[280px] lg:max-w-[320px] xl:max-w-[360px] flex items-start"
  ...
  return (
    <>
      ...
      <div className="md:hidden">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              <p>
                Editado Studio is an editorial practice focused on publishing, research, and narrative design. We collaborate with media outlets, foundations, and independent creators to shape stories, aesthetics, and strategies with clarity and purpose.
              </p>
              <p>
                Our work spans building narrative frameworks, refining editorial voice, and prototyping content ecosystems that are culturally attuned and strategically grounded.
              </p>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.div
              ...
              animate={{ height: hoveredCapability ? 'auto' : 0 }}
              transition={{ duration: 0.3, ease: "easeOut" }}
            >
              <motion.div
                className="py-4 px-3"
                ...
                animate={{ 
                  ...
                  filter: hoveredCapability ? 'blur(0px)' : 'blur(10px)'
                }}
                transition={{ duration: 0.4, ease: "easeOut" }}
              >
                {hoveredCapability && (
                  <p className="text-[13px] text-[#666666] font-ibm-mono leading-tight tracking-wide">
                    {capabilityDescriptions[hoveredCapability as keyof typeof capabilityDescriptions]}
                  </p>
                )}
              </motion.div>
            </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.div 
              ...
              variants={contentVariants}
            >
              <p>Helping a leading crypto media outlet scale its editorial and distribution strategy across languages and markets.</p>
              <p>Ideating an alternative media outlet that covers Argentina's food system and maps local real-food brands.</p>
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="hidden md:block">
        <div className="px-3 md:px-6 lg:px-0 pt-32 lg:pt-40 pb-28 lg:pb-32">
          ...
          <div className="grid grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-start">
            ...
            <div className="pr-6 md:pr-8 lg:pr-10">
              ...
              >
                <motion.h1 
                  className="font-sans text-[44px] lg:text-[48px] xl:text-[52px] tracking-normal leading-[1.02] max-w-[98%]"
                  initial="hidden"
                  animate="visible"
                  variants={simpleTextVariants}
                  style={{
            ...
            <div className="scrollable-content-column">
              ...
              >
                ...
                >
                  ...
                  >
                    <h2 className="text-footer tracking-wide leading-tight font-ibm-mono font-normal text-functional">About</h2>
                  </motion.div>
                  <motion.div 
                  ...
                  >
                    <div className="space-y-5 text-content tracking-wide leading-tight font-sans">
                      ...
                      <p>
                        ...
                        , an entrepreneur and editor based in Buenos Aires with over a decade of experience in international media, including CoinDesk, and cited by outlets such as the Financial Times and El País.
                      </p>
                    </div>
                  </motion.div>
                </motion.div>
                ...
                >
                  <motion.div 
                    ...
                    variants={sectionTitleVariants}
                  >
                    <h2 className="text-footer tracking-wide leading-tight font-ibm-mono font-normal text-functional">Capabilities</h2>
                  </motion.div>
                  <motion.div 
                    className="col-start-4 col-span-9 lg:col-start-4 lg:col-span-9"
                    variants={contentVariants}
                ...
                >
                  ...
                  >
                    <div className="space-y-2.5 text-content tracking-wide leading-normal font-sans">
                      <p>Helping a leading crypto media outlet scale its editorial and distribution strategy across languages and markets.</p>
                      <p ref={lastLineRef}>Ideating an alternative media outlet that covers Argentina's food system and maps local real-food brands.</p>
                    </div>
                  </motion.div>
                </motion.div>
              </motion.div>
